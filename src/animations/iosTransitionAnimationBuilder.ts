...
export const iosTransitionAnimationBuilder = (navEl, opts) => {
  var _a;
  try {
    ...
    rootAnimation
      ...
      .duration(
        ((_a = opts.duration) !== null && _a !== void 0 ? _a : 0) || DURATION
      )
    ...
    enteringToolBarEls.forEach((enteringToolBarEl) => {
      ...
      const inactiveHeader =
        parentHeader === null || parentHeader === void 0
          ? void 0
